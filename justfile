...
crap: coverage
    uv run --locked python scripts/quality/crap_report.py --coverage-json /tmp/osm-polygon-website-tag-coverage.json --path src/osm_polygon_website_tag/domain/tags.py --path src/osm_polygon_website_tag/contracts/polygon_schema.py --path src/osm_polygon_website_tag/application/workflow.py --path src/osm_polygon_website_tag/reporting/verify.py --path src/osm_polygon_website_tag/reporting/verification/shards.py --path src/osm_polygon_website_tag/reporting/verification/text.py --path src/osm_polygon_website_tag/reporting/verification/rows.py --path src/osm_polygon_website_tag/reporting/verification/analysis.py --path src/osm_polygon_website_tag/reporting/verification/receipt.py --max-crap 6
