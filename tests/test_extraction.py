...
from osm_polygon_website_tag.extraction import (
    ExtractFailure,
    ExtractionResult,
    _ExtractionHandler,
    extract_pbf,
...
from osm_polygon_website_tag.run_state import SourceFingerprint, load_run
...
def test_source_mutation_fails_before_shard_promotion(
    ...
    monkeypatch.setattr(
        "osm_polygon_website_tag.extraction.snapshot_source_fingerprint",
...
""",
    ...
    from osm_polygon_website_tag.extraction import _ExtractionHandler
...
def test_keyboard_interrupt_keeps_extracting_run_resumable(
    ...
    from osm_polygon_website_tag import extraction
...
def test_extraction_promotion_failure_preserves_previous_bundle(
    ...
    monkeypatch.setattr(
        "osm_polygon_website_tag.extraction.atomic_promote_bundle",
        fail_promotion,
    )
